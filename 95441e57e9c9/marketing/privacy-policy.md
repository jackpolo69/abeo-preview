...
**⚠️ COUNSEL REVIEW REQUIRED BEFORE PUBLICATION.** This Privacy Policy harmonizes HIPAA, CCPA / CPRA, and California-specific privacy rules with the actual data handling Abeó will perform. California-licensed counsel must finalize before publication on `abeo.health`.
...
### 2.1 From Clients (at intake and during service)
- Identifying information: full legal name, preferred name, date of birth, address, phone, email
- Contact information for emergency contacts and authorized representatives
- Healthcare information: physician names, diagnoses, medications, allergies, mobility status, cognitive status (governed by HIPAA)
- Insurance information: plan name, member ID, group number
- Living situation and home access details
- Care preferences, dietary requirements, cultural and language preferences
- Photographs (only with explicit consent, e.g., for caregiver familiarity)
- Service usage data: visit logs, ride logs, coordination notes

### 2.2 From Family Members and Authorized Representatives
- Identifying information: name, contact info, relationship to client
- Authorization documentation (Power of Attorney, conservatorship, etc.)
- Communication content (messages, calls with coordinators)
- Family-app usage data

### 2.3 From Caregivers and Employees
- Identifying information, contact, address
- Employment records: HCAR registration, DOJ/FBI clearance, training records, performance evaluations
- Compensation, tax, and payroll information
- Caregiver-app usage data: clock-in/out, visit logs, activity entries

### 2.4 From Website Visitors and App Users
- Browser and device information (IP address, browser type, device identifiers)
- Pages visited, time on site, click patterns
- Cookies and similar technologies (see §6)
- Form submissions (contact forms, intake inquiries, recruiting applications)
...
- Match caregivers to client needs
- Schedule visits and rides
- Coordinate care plans across the care team
- Communicate with families about their loved one's care
- Process payments and insurance claims
- Maintain CDSS-required client records

### 3.2 To Comply with Law
- CDSS HCO licensing requirements (record retention per Health & Safety Code §1796.20)
- HIPAA Privacy and Security Rules
- Mandated abuse reporting (Welfare & Institutions Code §15630)
- Tax and employment law requirements
- Subpoenas, court orders, and lawful government requests

### 3.3 To Improve Services
...
### 3.4 abeoOS Data Practices (Phase 4 onward — not yet active)
...
**Privacy commitments that govern abeoOS data use** (from `marketing/marketing-plan-6-phase.md` cross-phase principle 6):
...
### 4.1 With Caregivers Assigned to the Client
...
### 4.2 With Authorized Family Members
...
### 4.4 With Hospital and Discharge Partners
...
### 4.5 With Third-Party Service Providers (Business Associates)
...
### 4.7 In Mandated Reporting Situations
...
### 4.8 With Investors and Acquirers (Business Transactions)
...
### 5.1 California Consumer Privacy Act (CCPA / CPRA) Rights
...
### 6.1 What We Use
The abeo.health website uses:
- **Strictly necessary cookies** — for authentication and basic site functionality
- **Functional cookies** — to remember preferences (language, accessibility settings)
- **Analytics cookies** — privacy-respecting analytics to understand site usage (no cross-site tracking)

We do NOT use:
- Third-party advertising cookies
- Cross-site behavioral tracking
- Social media share-trackers without consent
...
Our services are designed for adults (18+). We do not knowingly collect personal information from children under 13. If a parent or guardian believes we have inadvertently collected such information, please contact us at info@abeo.health for prompt deletion.
